...
Configure access to services external network
--------------------------------------------------

Kuryr creates automatically an external network for services `raven-default-external-net` and
a subnet for the default namespace `raven-default-external-subnet`.

For the purpose of this demo, it is necessary that this subnet be accessible from the ost-controller host.
